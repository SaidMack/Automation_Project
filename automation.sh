...
myname="said"
s3_bucket="upgrad-saidahmedelsafadi/logs"
...
tar -cvf /tmp/${said}-httpd-logs-${timestamp}.tar *.log

echo "Copying logs to s3"

aws s3 \
cp /tmp/${said}-httpd-logs-${timestamp}.tar \
s3://${s3_bucket}/${said}-httpd-logs-${timestamp}.tar
...
echo "<br>httpd-logs &nbsp;&nbsp;&nbsp;&nbsp; ${timestamp} &nbsp;&nbsp;&nbsp;&nbsp; tar &nbsp;&nbsp;&nbsp;&nbsp; `du -h /tmp/${said}-httpd-logs-${timestamp}.tar | awk '{print $1}'`" >> /var/www/html/inventory.html
